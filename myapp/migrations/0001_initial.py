    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant_image', models.ImageField(null=True, upload_to='restaurant_image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('resturant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.restaurantname')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket_raise',
            fields=[
                ...
                ('attach_file', models.FileField(upload_to='tictet_raise')),
